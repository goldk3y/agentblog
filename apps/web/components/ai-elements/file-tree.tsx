...
// Local change to the upstream AI Elements source: this repository compiles with
// `exactOptionalPropertyTypes`, under which an absent property and one set to
// `undefined` are different types. The context value is built from props that
// may genuinely be `undefined`, so the optional members have to say so.
