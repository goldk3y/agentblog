...
writes 81 files into your repository: the routes, the structured data, the
...
agent can genuinely maintain. Installing AgentBlog also writes seven skills into
...
| Agent skills         | Seven skills covering setup, research, planning, writing, refreshing, auditing, publishing    |
