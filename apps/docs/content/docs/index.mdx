...
writes 76 files into your repository: the routes, the structured data, the
...
agent can genuinely maintain. Installing AgentBlog also writes six skills into
...
| Agent skills         | Six skills covering setup, planning, writing, refreshing, auditing, and publishing            |
