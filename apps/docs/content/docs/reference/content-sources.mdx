...
description: Where posts come from, the MDX source that ships with the blog, and what it takes to write your own.
icon: FileText
---
...
### The two files posts point into
...
### `prerenderStrategy` prevents the worst failure in the system
