...
- Seven skills in `.claude/skills/`, so your coding agent knows how to finish
  the setup, research and plan the topics, and write, refresh, audit, and publish
  a post without being told.
